...
<div class="resumeFormWrap">
                        ...
                        <div class="resume_con">
                            ...
                            <section id="basic" class="resume_basic">
                                <div class="resume_view" style="display: block;">
                                    ...
                                    <ul class="user_info">
                                        <li class="user_email">${userInfo.member.memMail }</li>
                                        <li class="user_phone">${userInfo.member.memTel }</li>
                                        <li class="user_address">(${userInfo.member.memZip }) ${userInfo.member.memAddr1 } ${userInfo.member.memAddr2 }</li>
                                    </ul>
                            ...
                            <section id="career" class="resume_career">
                                <div class="resume_tit">
                                    ...
                                    <button type="button" onclick="fJhAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 경력 템플릿 (숨김) -->
                                <div id="resumeCareerItem" class="resume_edit wrapHiddenForm" data-tpl="career-item" style="display: none;">
                                    <div class="item_row item_center">
                                        <div class="TypoBox TypeBtn item_m">
                                            ...
                                            <input type="text" id="careerCompanyNm_1701183047064" class="Typo SizeL" placeholder="회사명 *" maxlength="80">
                                        </div>
                                        <div class="TypoBox item item_s LblTop">
                                            <label for="careerStart_1701183047064" class="Lbl">입사일자 *</label>
                                            <input type="text" id="careerStart_1701183047064" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                        <div class="TypoBox item item_s LblTop">
                                            <label for="careerEnd_1701183047064" class="Lbl">퇴사일자 *</label>
                                            <input type="text" id="careerEnd_1701183047064" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    ...
                                    <button type="button" onclick="fJhRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 경력 입력 필드 (보임) -->
                                <div id="resumeCareerItem" class="resume_edit wrapHiddenForm" data-tpl="career-item">
                                    <div class="item_row item_center">
                                        <div class="TypoBox TypeBtn item_m">
                                            <label for="careerCompanyNm_1701183047064" class="blind">회사명</label>
                                            <input type="text" name="careerVOList[0].crCompanynm" id="careerCompanyNm_1701183047064" class="Typo SizeL" placeholder="회사명 *" maxlength="80">
                                        </div>
                                        <div class="TypoBox item item_s LblTop">
                                            <label for="careerStart_1701183047064" class="Lbl">입사일자 *</label>
                                            <input type="text" name="careerVOList[0].crStdate" id="careerStart_1701183047064" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                        <div class="TypoBox item item_s LblTop">
                                            <label for="careerEnd_1701183047064" class="Lbl">퇴사일자 *</label>
                                            <input type="text" name="careerVOList[0].crEndate" id="careerEnd_1701183047064" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <h5 class="tit_sub">담당업무</h5>
                                    <div class="item_row">
                            ...
                            <section id="school" class="resume_school">
                                <div class="resume_tit">
                                    ...
                                    <button type="button" onclick="fShAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 학력 템플릿 (숨김) -->
                                <div id="resumeSchoolItem" class="resume_edit wrapHiddenForm" data-tpl="school-university" style="display:none">
                                    <div class="item_row item_center">
                                        <div class="TypoBox TypeBtn item_m">
                                            ...
                                            <input type="text" id="schoolNm_1701183039921" class="Typo SizeL" maxlength="100" placeholder="학교명 *">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_m LblTop">
                                            <label class="Lbl" for="schoolMajor_1701183039921">전공 *</label>
                                            <input type="text" id="schoolMajor_1701183039921" class="Typo SizeL" maxlength="50" placeholder="전공 *">
                                        </div>
                                        ...
                                        <div class="TypoBox item_s LblTop">
                                            ...
                                            <input type="text" id="schoolEntranceDt_1701183039921" class="Typo SizeL onlyNumber DatePic datePicker" maxlength="8" placeholder="YYYYMMDD">
                                        </div>
                                        <div class="TypoBox item_s LblTop">
                                            <label for="schoolGraduationDt_1701183039921" class="Lbl">졸업일자</label>
                                            <input type="text" id="schoolGraduationDt_1701183039921" class="Typo SizeL onlyNumber DatePic datePicker" maxlength="8" placeholder="YYYYMMDD">
                                        </div>
                                        <div class="item_row item_center" style="display: flex;">
                                            <div class="TypoBox item_s LblTop">
                                                <label for="schoolMajorAvg_1701609400844" class="Lbl">학점</label>
                                                <input type="text" id="schoolMajorAvg_1701609400844" class="Typo SizeL onlyNumber additionalItem" maxlength="5" placeholder="학점">
                                            </div>
                                            <div class="InpBox SizeL item_s">
                                    ...
                                    <button type="button" onclick="fShRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 학력 입력 필드 (보임) -->
                                <div id="resumeSchoolItem" class="resume_edit wrapHiddenForm" data-tpl="school-university">
                                    <div class="item_row item_center">
                                        <div class="TypoBox TypeBtn item_m">
                                            <label class="blind" for="schoolNm_1701183039921">학교명 *</label>
                                            <input type="text" name="educationVOList[0].eduSchoolnm" id="schoolNm_1701183039921" class="Typo SizeL" maxlength="100" placeholder="학교명 *">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_m LblTop">
                                            <label class="Lbl" for="schoolMajor_1701183039921">전공 *</label>
                                            <input type="text" name="educationVOList[0].eduMajornm" id="schoolMajor_1701183039921" class="Typo SizeL" maxlength="50" placeholder="전공 *">
                                        </div>
                                        <div class="InpBox SizeL item_s">
                                        ...
                                        <div class="TypoBox item_s LblTop">
                                            <label for="schoolEntranceDt_1701183039921" class="Lbl">입학일자</label>
                                            <input type="text" name="educationVOList[0].eduStdate" id="schoolEntranceDt_1701183039921" class="Typo SizeL onlyNumber DatePic datePicker" maxlength="8" placeholder="YYYYMMDD">
                                        </div>
                                        <div class="TypoBox item_s LblTop mt-2">
                                            <label for="schoolGraduationDt_1701183039921" class="Lbl">졸업일자</label>
                                            <input type="text" name="educationVOList[0].eduEndate" id="schoolGraduationDt_1701183039921" class="Typo SizeL onlyNumber DatePic datePicker" maxlength="8" placeholder="YYYYMMDD">
                                        </div>
                                        <div class="item_row item_center mt-2" style="display: flex;">
                                            <div class="TypoBox item_s LblTop">
                                                <label for="schoolMajorAvg_1701609400844" class="Lbl">학점</label>
                                                <input type="text" name="educationVOList[0].eduGrade" id="schoolMajorAvg_1701609400844" class="Typo SizeL onlyNumber additionalItem" maxlength="5" placeholder="학점">
                                            </div>
                                            <div class="InpBox SizeL item_s">
                            ...
                            <!-- 학력 끝 -->
                            <!-- 경험/활동/교육 -->
                            <section id="activity" class="resume_edu">
                                <div class="resume_tit">
                                    <div class="box_tit">
                                        <h2 class="tit">경험/활동/교육</h2>
                                    </div>
                                    <button type="button" onclick="fAtAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 경험/활동 템플릿 (숨김) -->
                                <div id="resumeActivityItem" class="resume_edit wrapHiddenForm" data-tpl="activity-item" style="display: none;">
                                    <div class="item_row item_center">
                                        <div class="TypoBox item_m LblTop">
                                            ...
                                            <input type="text" id="activityOrg_1701183028892" class="Typo SizeL" placeholder="기관/장소명 *" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="activityStart_1701183028892" class="Lbl">시작일자</label>
                                            <input type="text" id="activityStart_1701183028892" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                        <div class="TypoBox item_s LblTop">
                                            <label for="activityEnd_1701183028892" class="Lbl">종료일자</label>
                                            <input type="text" id="activityEnd_1701183028892" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <h5 class="tit_sub">활동 설명</h5>
                                    <div class="item_row">
                                        <div class="InpBox letter_box item_full">
                                            <textarea id="activityContents_1701183028892" class="ScrollBar charCount" placeholder="경험/활동/교육 상세내용 입력"></textarea>
                                        </div>
                                    </div>
                                    <button type="button" onclick="fAtRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 경험/활동 입력 필드 (보임) -->
                                <div id="resumeActivityItem" class="resume_edit wrapHiddenForm" data-tpl="activity-item">
                                    <div class="item_row item_center">
                                        <div class="TypoBox item_m LblTop">
                                            <label for="activityOrg_1701183028892" class="Lbl">기관/나라/장소명 *</label>
                                            <input type="text" name="intrnActvtVOList[0].iaName" id="activityOrg_1701183028892" class="Typo SizeL" placeholder="기관/장소명 *" maxlength="50">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="activityStart_1701183028892" class="Lbl">시작일자</label>
                                            <input type="text" name="intrnActvtVOList[0].iaStdate" id="activityStart_1701183028892" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                        <div class="TypoBox item_s LblTop">
                                            <label for="activityEnd_1701183028892" class="Lbl">종료일자</label>
                                            <input type="text" name="intrnActvtVOList[0].iaEndate" id="activityEnd_1701183028892" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <h5 class="tit_sub">활동 설명</h5>
                                    <div class="item_row">
                                        <div class="InpBox letter_box item_full">
                                            <textarea name="intrnActvtVOList[0].iaContent" id="activityContents_1701183028892" class="ScrollBar charCount" placeholder="경험/활동/교육 상세내용 입력"></textarea>
                                        </div>
                                    </div>
                                    <button type="button" onclick="fAtRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                            ...
                            <!-- 경험/활동/교육 끝 -->
                            <!-- 자격증 -->
                            <section id="license" class="resume_license">
                                <div class="resume_tit">
                                    <div class="box_tit">
                                        <h2 class="tit">자격증</h2>
                                    </div>
                                ...
                                <div id="resumeLicenseItem" class="resume_edit wrapHiddenForm" data-tpl="license-license" style="display: none;">
                                    <div class="item_row">
                                        <div class="TypoBox TypeBtn item_m">
                                            ...
                                            <input type="text" id="licenseNm_1701183020055" class="Typo SizeL" placeholder="자격증명 *" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="licenseObtainDt_1701183020055" class="Lbl">합격일자</label>
                                            <input type="text" id="licenseObtainDt_1701183020055" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <button type="button" onclick="fLiRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 자격증 입력 필드 (보임) -->
                                <div id="resumeLicenseItem" class="resume_edit wrapHiddenForm" data-tpl="license-license">
                                    <div class="item_row">
                                        <div class="TypoBox TypeBtn item_m">
                                            <label class="blind" for="licenseNm_1701183020055">자격증명</label>
                                            <input type="text" name="certificateVOList[0].cerNm" id="licenseNm_1701183020055" class="Typo SizeL" placeholder="자격증명 *" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="licenseObtainDt_1701183020055" class="Lbl">합격일자</label>
                                            <input type="text" name="certificateVOList[0].cerDateAcqst" id="licenseObtainDt_1701183020055" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <button type="button" onclick="fLiRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                            ...
                            <section id="language" class="resume_language">
                                <div class="resume_tit">
                                    ...
                                    <button type="button" onclick="fLgAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 어학 템플릿 (숨김) -->
                                <div id="resumeLanguageItem" class="resume_edit wrapHiddenForm" data-tpl="license-language-exam" style="display: none;">
                                    <div class="item_row">
                                        ...
                                        <div class="TypoBox TypeBtn item_m">
                                            ...
                                            <input type="text" id="langExamNm_1701243506207" class="Typo SizeL" placeholder="언어 선택 후 어학시험명 입력">
                                        </div>
                                        <div class="TypoBox item_s LblTop">
                                            <label for="langExamObtainDt_1701243506207" class="Lbl">취득일자</label>
                                            <input type="text" id="langExamObtainDt_1701243506207" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="langExamScore_1701243506207" class="Lbl">점수</label>
                                            <input type="text" id="langExamScore_1701243506207" class="Typo SizeL onlyNumber" placeholder="점수" maxlength="7">
                                        </div>
                                    </div>
                                    <button type="button" onclick="fLgRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 어학 입력 필드 (보임) -->
                                <div id="resumeLanguageItem" class="resume_edit wrapHiddenForm" data-tpl="license-language-exam">
                                    <div class="item_row">
                                        <div class="InpBox SizeL item_s">
                                            <label for="langExamLangcode_1701243506207" class="blind">언어</label>
                                        ...
                                        <div class="TypoBox TypeBtn item_m">
                                            <label for="langExamNm_1701243506207" class="blind">어학시험명</label>
                                            <input type="text" name="languageVOList[0].lagTestnm" id="langExamNm_1701243506207" class="Typo SizeL" placeholder="언어 선택 후 어학시험명 입력">
                                        </div>
                                        <div class="TypoBox item_s LblTop">
                                            <label for="langExamObtainDt_1701243506207" class="Lbl">취득일자</label>
                                            <input type="text" name="languageVOList[0].lagDateAcqst" id="langExamObtainDt_1701243506207" class="Typo SizeL onlyNumber DatePic datePicker" placeholder="YYYYMMDD" maxlength="8">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="TypoBox item_s LblTop">
                                            <label for="langExamScore_1701243506207" class="Lbl">점수</label>
                                            <input type="text" name="languageVOList[0].lagLevel" id="langExamScore_1701243506207" class="Typo SizeL onlyNumber" placeholder="점수" maxlength="7">
                                        </div>
                                    </div>
                                    <button type="button" onclick="fLgRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                            ...
                            <!-- 어학 끝 -->
                            <!-- 포트폴리오 -->
                            <section id="attach_files" class="resume_etc">
                                <div class="resume_tit">
                                    <div class="box_tit">
                                        <h2 class="tit">포트폴리오</h2>
                                    </div>
                                    <button type="button" onclick="fPfAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 포트폴리오 템플릿 (숨김) -->
                                <div id="resumeAttachFiles" class="resume_edit wrapHiddenForm" data-tpl="attach-files" style="display: none;">
                                    <div class="item_row">
                                        <div class="TypoBox item_full LblTop">
                                            ...
                                            <input type="text" id="introTitle_1701183010781" name="resumePortfolio" class="Typo SizeL" placeholder="http://" maxlength="100">
                                        </div>
                                    </div>
                                    <button class="btn btn-outline-secondary" onclick="fPfRemove(this)">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 포트폴리오 입력 필드 (보임) -->
                                <div id="resumeAttachFiles" class="resume_edit wrapHiddenForm" data-tpl="attach-files">
                                    <div class="item_row">
                                        <div class="TypoBox item_full LblTop">
                                            <label for="introTitle_1701183010781" class="Lbl">URL</label>
                                            <input type="text" id="introTitle_1701183010781" name="resumePortfolio" class="Typo SizeL" placeholder="http://" maxlength="100">
                            ...
                            <!-- 포트폴리오 끝 -->
                            <!-- 자기소개서 -->
                            <section id="introduce" class="resume_letter">
                                <div class="resume_tit">
                                    <div class="box_tit">
                                        <h2 class="tit">자기소개서</h2>
                                    </div>
                                    <button type="button" onclick="fInAdd()" class="btn btn-outline-primary">+ 추가</button>
                                </div>
                                <!-- 자기소개서 템플릿 (숨김) -->
                                <div id="resumeIntroduceItem" class="resume_edit wrapHiddenForm" data-tpl="introduce-item" style="display: none;">
                                    <div class="item_row item_nowrap">
                                        <div class="TypoBox item_full LblTop">
                                            ...
                                            <input type="text" id="introTitle_1701183010781" class="Typo SizeL" placeholder="자기소개서 제목" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="InpBox letter_box item item_full">
                                    ...
                                    <button type="button" onclick="fInRemove(this)" class="btn btn-outline-secondary">
                                        <i class="fa-solid fa-trash"></i>
                                    </button>
                                </div>
                                <!-- 자기소개서 입력 필드 (보임) -->
                                <div id="resumeIntroduceItem" class="resume_edit wrapHiddenForm" data-tpl="introduce-item">
                                    <div class="item_row item_nowrap">
                                        <div class="TypoBox item_full LblTop">
                                            <label for="introTitle_1701183010781" class="Lbl">자기소개서 제목</label>
                                            <input type="text" id="introTitle_1701183010781" name="coverLetterVOList[0].psTitle" class="Typo SizeL" placeholder="자기소개서 제목" maxlength="100">
                                        </div>
                                    </div>
                                    <div class="item_row">
                                        <div class="InpBox letter_box item item_full">
                            ...
                            <section id="open_status" class="resume_open">
                                <input type="hidden" name="open_fl" value="n" id="open_fl">
                                <input type="hidden" name="recomnd_status" value="n" id="recomnd_status">
                                <input type="hidden" name="re_consent" value="n" id="re_consent">
                                <input type="hidden" name="allow_company_codes" value="" id="allow_company_codes">
                                <input type="hidden" name="cell_open_fl" value="y" id="cell_open_fl">
                                <input type="hidden" name="email_open_fl" value="n" id="email_open_fl">
                                <input type="hidden" name="tel_open_fl" value="y" id="tel_open_fl">
                                <input type="hidden" name="cell_privacy" value="n" id="cell_privacy">
                                        ...
                                        <li>
                                            <div class="InpBox Bg White">
                                                <span class="Rdo">
                                                    ...
                                                    <label class="Lbl" for="openStatusActive">이력서 공개</label>
                                                </span>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="InpBox Bg White">
                                                <span class="Rdo">
                                                    ...
                                                    <label class="Lbl" for="openStatusRecomnd">이력서 비공개</label>
                                                </span>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="resume_btm">
                        <section id="resume_title">
                            <div class="inner">
                                ...
                                <input type="text" id="title" name="resumeTitle" class="resume_title_input" placeholder="이력서 제목을 입력하세요." maxlength="100" autocomplete="off">
                                <button type="button" id="resumeAutoInsert" class="BtnType BtnTypeRd SizeML btn_preview">이력서 자동완성</button>
                                <input type="submit" value="작성완료" class="BtnType BtnTypeRd SizeML">
                            </div>
                        </section>
                    </div>
                </form>
 ...
 <script>
     ...
     function fPfRemove(pThis) {
         ...
         console.log("체크:", $(pThis).closest(".resume_edit")[0]);
